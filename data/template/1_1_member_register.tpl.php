...
0
|| checktplrefresh('./template/default/member/register.htm', './template/default/common/seccheck.htm', 1499880148, '1', './data/template/1_1_member_register.tpl.php', './template/default', 'member/register')
...
<td class="tipcol"><i id="tip_<?php echo $this->setting['reginput']['username'];?>" class="p_tip">昵称名由 3 到 15 个字符组成</i><kbd id="chk_<?php echo $this->setting['reginput']['username'];?>" class="p_chk"></kbd></td>
</tr>
</table>
</div>
